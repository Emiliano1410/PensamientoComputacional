def obtener_estadisticas_equipo(nombre_equipo):
    ...
    while True:
        try:
            estadisticas_equipo['victorias'] = int(input(f"Ingrese el número de victorias de {nombre_equipo}: "))
            estadisticas_equipo['derrotas'] = int(input(f"Ingrese el número de derrotas de {nombre_equipo}: "))
            estadisticas_equipo['empates'] = int(input(f"Ingrese el número de empates de {nombre_equipo}: "))
            estadisticas_equipo['anotados'] = int(input(f"Ingrese el número de goles anotados por {nombre_equipo}: "))
            estadisticas_equipo['contra'] = int(input(f"Ingrese el número de goles en contra de {nombre_equipo}: "))
            estadisticas_equipo['puntos'] = int(input(f"Ingrese el número de puntos del torneo de {nombre_equipo}: "))
            estadisticas_equipo['vcinco'] = int(input(f"Ingrese el número de victorias en los últimos cinco partidos de {nombre_equipo}: "))
            estadisticas_equipo['dcinco'] = int(input(f"Ingrese el número de derrotas en los últimos cinco partidos de {nombre_equipo}: "))
            estadisticas_equipo['titulares'] = int(input(f"Ingrese el número de jugadores titulares lesionados de {nombre_equipo}: "))
            estadisticas_equipo['promedio'] = float(input(f"Ingrese el promedio de goles por partido de {nombre_equipo}: "))
            estadisticas_equipo['tiros_arco'] = float(input(f"Ingrese el promedio de tiros al arco por partido de {nombre_equipo}: "))
            estadisticas_equipo['posesion'] = float(input(f"Ingrese el promedio de porcentaje de posesión del balón por partido de {nombre_equipo}: "))
            estadisticas_equipo['paradas_portero'] = float(input(f"Ingrese el promedio de paradas del portero por partido de {nombre_equipo}: "))
            estadisticas_equipo['victorias_ult5_entre_ellos'] = int(input(f"Ingrese el número de victorias en los últimos cinco enfrentamientos entre estos equipos para {nombre_equipo}: "))
...
while True:
    ...
    estadisticas_equipo1 = obtener_estadisticas_equipo(EQUIPO1)

    EQUIPO2 = input("Ingrese el nombre del EQUIPO 2: ")
    estadisticas_equipo2 = obtener_estadisticas_equipo(EQUIPO2)
