def obtener_estadisticas_equipo(nombre_equipo):
    ...
    while True:
        try:
            ...
            estadisticas_equipo = [victorias, derrotas, empates, anotados, contra, puntos, vcinco, dcinco, titulares, promedio, tiros_arco, posesion, paradas_portero, victorias_ult5_entre_ellos]
